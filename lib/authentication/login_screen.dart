...
import 'package:ridewave_riders/authentication/forgotPassword.dart';
...
import 'package:ridewave_riders/pages/vehicleInfoScreen.dart';
    ...
    if (userFirebase != null) {
      ...
      usersRef.once().then((snap) {
        if (snap.snapshot.value != null) {
          ...
          if ((snap.snapshot.value as Map)["vehicle_details"] == "") {
            Navigator.push(
                context, MaterialPageRoute(builder: (c) => const VehicleInfoScreen()));
          }
        } else {
          FirebaseAuth.instance.signOut();
          cMethods.displaySnackBar(
